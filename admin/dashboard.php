...
<head>
    ...
    <title>Admin | Bookstore</title> </head> <body>
            <!-- ============================================================== -->
            <!-- main wrapper -->
            <!-- ============================================================== -->
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div id="submenu-5" class="collapse submenu" style="">
                                            <ul class="nav flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" href="pages/tables/siswa/table_siswa.php">Data
                                                        Siswa</a>
                                                </li>
                                                <li class="nav-item">
                        ...
                        <div class="container-fluid dashboard-content ">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p><b>Bookstore</b> merupakan aplikasi web Buku. 
                                            Di aplikasi ini, terdapat pembagian user/multi user yaitu
                                            Admin dan Siswa. Selain itu aplikasi ini terdiri
                                            dari menu Buku, Siswa, Kategori, Penerbit, Pengarang, User.
                                            Diharapkan aplikasi ini dapat memudahkan pekerjaan dalam
                                            melakukan pendataan buku, pengarang, dan penulis.</p>
