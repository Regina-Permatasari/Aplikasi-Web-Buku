                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="table_siswa.php">Data Siswa</a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="table_siswa.php" class="breadcrumb-link">Data
                                                    siswa</a></li>
                                            <li class="breadcrumb-item active" aria-current="page"></li>Form siswa
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="process/edit_siswa.php" method="POST">

                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">ID siswa</label>
                                        <div class="col-md-9">
                                            <input type="text" name="id_siswa" class="form-control" value="<?php echo $id_siswa ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="nama_siswa" class="form-control" placeholder="Nama siswa"
                                                value="<?php echo $item['nama_siswa'] ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="custom-control custom-radio">
                                                <input id="lakilaki" name="jk_siswa" type="radio" class="custom-control-input"
                                                    required="" value="Laki-Laki" <?php if($item['jk_siswa']=="Laki-Laki"
                                                    ) { echo "checked" ;} ?>>
                                                <label class="custom-control-label" for="lakilaki">Laki-Laki</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input id="perempuan" name="jk_siswa" type="radio" class="custom-control-input"
                                                    required="" value="Perempuan" <?php if($item['jk_siswa']=="Perempuan"
                                                    ) { echo "checked" ;} ?>>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="alamat_siswa" id="" cols="30" rows="10" class="form-control"
                                                placeholder="Alamat siswa" required><?php echo $item['alamat_siswa'] ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="email" name="email_siswa" class="form-control" placeholder="Email"
                                                value="<?php echo $item['email_siswa'] ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="telp_siswa" class="form-control" placeholder="Nomor Telepon"
                                                value="<?php echo $item['telp_siswa'] ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-5">
                                        <div class="col-md-6">
                                            <!-- back to home -->
                                            <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg" href="table_siswa.php"
