                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="process/add_siswa.php" method="POST">

                                    <?php 
                                    $tampilkan_isi = "select count(id_siswa) as jumlah from siswa;";
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="id_siswa" class="form-control" value="SIS-<?php echo $no+$jumlah ?>"
                                                readonly>
                                        </div>
                                    </div>
