                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="form_siswa.php" class="btn btn-primary">Tambah Data</a>
                                <?php
                                $message = '';
                                if(isset($_GET["error"]))
                                {
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = "SELECT * FROM siswa where deleted=0";
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href='form_edit_siswa.php?id_siswa=$id_siswa'></a>
                                                            <a href='process/delete_siswa.php?id_siswa=$id_siswa' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
