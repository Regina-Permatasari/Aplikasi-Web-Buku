                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select required name="id_siswa" class="form-control">
                                                ...
                                                <?php 
                                                $tampilkan_isi = "select siswa.id_siswa,siswa.nama_siswa from user
                                                RIGHT OUTER JOIN siswa
                                                ON user.id_siswa = siswa.id_siswa
                                                WHERE user.id_siswa IS NULL";
                                                $tampilkan_isi_sql = mysqli_query($con,$tampilkan_isi);
                                            
                                                while ($isi = mysqli_fetch_array($tampilkan_isi_sql))
                                                {
                                                    echo "<option value='".$isi['id_siswa']."'>".$isi['nama_siswa']."</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
