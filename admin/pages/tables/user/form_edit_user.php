...
$query = "select u.id_siswa,c.nama_siswa,u.username,u.password from user u,siswa c where u.id_siswa = '$id_siswa'
AND u.id_siswa = c.id_siswa";
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="../siswa/table_siswa.php">Data Siswa</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div class="card-body">
                                <form action="process/edit_user.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="siswa" class="form-control" value="<?php echo $item['nama_siswa']; ?>"
                                                readonly>
                                        </div>
                                    </div>
