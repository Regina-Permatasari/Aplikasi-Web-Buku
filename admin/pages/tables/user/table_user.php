                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>******</td>
                                                        <td>
                                                            <a href='form_edit_user.php?id_siswa=$id_siswa' class='btn btn-warning'>Update</a>
                                                            <a href='process/delete_user.php?id_siswa=$id_siswa' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
