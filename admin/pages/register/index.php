                ...
                <div class="card-body">
                    ...
                    <?php 
                        ...
                        ?>
                                ...
                                <input type="hidden" name="id_siswa" value="CUS-<?php echo $no+$jumlah; ?>">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="p-t-10">
                                        <label class="radio-container m-r-45">Laki-Laki
                                            <input type="radio" name="jk_siswa" value="Laki-Laki">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="radio-container">Perempuan
                                            <input type="radio" name="jk_siswa" value="Perempuan">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                                <textarea name="alamat_siswa" cols="50" rows="5" class="input--style-4"></textarea>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="email" name="email_siswa">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Phone Number</label>
                                    <input class="input--style-4" type="number" name="telp_siswa">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
